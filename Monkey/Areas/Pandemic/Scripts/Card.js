function Card(id, key, deck) {
    ...
    this.display.find(".back").attr("src", "/Areas/Pandemic/Content/img/cards/" + deck + "/back.png");
    ...
    this.setFace = function (id, key) {
        ...
        this.display.find(".front").attr("src", "/Areas/Pandemic/Content/img/cards/" + deck + "/" + key + ".png");
    }
