var Game = {
    ...
    join: function (game, deck) {
        ...
        if (game.ActivePlayerName == profile.name) {
            playSound("/Content/Agricola/audio/my-turn.wav");
        }
    ...
    updateActivePlayer: function (data) {
        if (data.ActivePlayerName && this.activePlayer != data.ActivePlayerName) {
            ...
            /*
            if(this.isMyTurn()){
                var snd = new Audio("/Content/Agricola/audio/my-turn.wav");
                snd.play();
            }*/
        }
    ...
    updateQuickCards: function (player, ids, begCount) {
        ...
        if (begCount > 0) {
            ...
            card.attr("data-image", "/Content/Agricola/img/cards/begging-card.jpg");
